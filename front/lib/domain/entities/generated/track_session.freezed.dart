...
/// Adds pattern-matching-related methods to [TrackSession].
extension TrackSessionPatterns on TrackSession {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TrackSession value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TrackSession() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String fullId, int firstObserved, int lastSeen)?
    $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TrackSession() when $default != null:
        return $default(_that.fullId, _that.firstObserved, _that.lastSeen);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String fullId, int firstObserved, int lastSeen) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _TrackSession():
