                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Gap(16),
                          const Text(
                            '1. Нажмите "Получить токен" и все последующие кнопочки в браузере пока не появится текст',
                          ),
                          const Text(
                          ...
                          const Text(
                            '2. Скопируйте данные из адресной строки\nв поле выше',
                          ),
                          const Gap(8),
                          const Text(
                            'Vk App Id: (мини?)-приложение-вк, которому разрешено запрашивать аудио.\nКак понять можно ли ему запрашивать аудио? По факту)))',
                          ),
                          const Text(
                            'Сейчас по дефолту уже используется пока что рабочий vk app id.',
                          ),
                          const Gap(16),
                          SizedBox(
