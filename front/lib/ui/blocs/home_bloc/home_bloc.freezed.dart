...
/// @nodoc
abstract mixin class _$SaveTokenCopyWith<$Res> implements $HomeEventCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ShowTokenDialog);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeState$Initial);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeEffect$TokenSaved);
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HomeEffect$TokenErrorCopyWith<HomeEffect$TokenError> get copyWith => _$HomeEffect$TokenErrorCopyWithImpl<HomeEffect$TokenError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeEffect$TokenError&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class $HomeEffect$TokenErrorCopyWith<$Res> implements $HomeEffectCopyWith<$Res> {
  factory $HomeEffect$TokenErrorCopyWith(HomeEffect$TokenError value, $Res Function(HomeEffect$TokenError) _then) = _$HomeEffect$TokenErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
...
@pragma('vm:prefer-inline') $Res call({Object? message = null,}) {
  return _then(HomeEffect$TokenError(
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeEffect$ShowTokenDialog);
}
