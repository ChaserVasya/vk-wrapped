...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoadStatistics&&const DeepCollectionEquality().equals(other._tracks, _tracks));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailedStatisticsState);
}
...
$DetailedStatisticsStateCopyWith(DetailedStatisticsState _, $Res Function(DetailedStatisticsState) __);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailedStatisticsState$Initial);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailedStatisticsState$Loading);
}
...
class DetailedStatisticsState$Data implements DetailedStatisticsState {
  const DetailedStatisticsState$Data({required final  Map<String, dynamic> statistics}): _statistics = statistics;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DetailedStatisticsState$DataCopyWith<DetailedStatisticsState$Data> get copyWith => _$DetailedStatisticsState$DataCopyWithImpl<DetailedStatisticsState$Data>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailedStatisticsState$Data&&const DeepCollectionEquality().equals(other._statistics, _statistics));
}
...
/// @nodoc
abstract mixin class $DetailedStatisticsState$DataCopyWith<$Res> implements $DetailedStatisticsStateCopyWith<$Res> {
  factory $DetailedStatisticsState$DataCopyWith(DetailedStatisticsState$Data value, $Res Function(DetailedStatisticsState$Data) _then) = _$DetailedStatisticsState$DataCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') $Res call({Object? statistics = null,}) {
  return _then(DetailedStatisticsState$Data(
statistics: null == statistics ? _self._statistics : statistics // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DetailedStatisticsState$ErrorCopyWith<DetailedStatisticsState$Error> get copyWith => _$DetailedStatisticsState$ErrorCopyWithImpl<DetailedStatisticsState$Error>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailedStatisticsState$Error&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class $DetailedStatisticsState$ErrorCopyWith<$Res> implements $DetailedStatisticsStateCopyWith<$Res> {
  factory $DetailedStatisticsState$ErrorCopyWith(DetailedStatisticsState$Error value, $Res Function(DetailedStatisticsState$Error) _then) = _$DetailedStatisticsState$ErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
...
@pragma('vm:prefer-inline') $Res call({Object? message = null,}) {
  return _then(DetailedStatisticsState$Error(
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DetailedStatisticsEffectCopyWith<DetailedStatisticsEffect> get copyWith => _$DetailedStatisticsEffectCopyWithImpl<DetailedStatisticsEffect>(this as DetailedStatisticsEffect, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailedStatisticsEffect&&(identical(other.message, message) || other.message == message));
}
...
abstract mixin class $DetailedStatisticsEffectCopyWith<$Res>  {
  factory $DetailedStatisticsEffectCopyWith(DetailedStatisticsEffect value, $Res Function(DetailedStatisticsEffect) _then) = _$DetailedStatisticsEffectCopyWithImpl;
@useResult
$Res call({
 String message
});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DetailedStatisticsEffect$ErrorCopyWith<DetailedStatisticsEffect$Error> get copyWith => _$DetailedStatisticsEffect$ErrorCopyWithImpl<DetailedStatisticsEffect$Error>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DetailedStatisticsEffect$Error&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class $DetailedStatisticsEffect$ErrorCopyWith<$Res> implements $DetailedStatisticsEffectCopyWith<$Res> {
  factory $DetailedStatisticsEffect$ErrorCopyWith(DetailedStatisticsEffect$Error value, $Res Function(DetailedStatisticsEffect$Error) _then) = _$DetailedStatisticsEffect$ErrorCopyWithImpl;
@override @useResult
$Res call({
 String message
});
...
@override @pragma('vm:prefer-inline') $Res call({Object? message = null,}) {
  return _then(DetailedStatisticsEffect$Error(
message: null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
