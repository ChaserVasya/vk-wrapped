            ...
            children: [
              ...
              if (state.tracks.isData) ...[
                ...
                if (state.tracks.dataOrNull?.isNotEmpty ?? false)
                  Text('First Track: ${state.tracks.dataOrNull!.first.title}'),
              ],
...
void main() {
  ...
  group('Debug Tests', () {
    ...
    setUp(() async {
      ...
      // Override in DI
      getIt.unregister<CacheServiceInterface>();
      getIt.registerSingleton<CacheServiceInterface>(mockCacheService);
      getIt.unregister<AudioBloc>();
    ...
    testWidgets('should debug state changes', (tester) async {
      await tester.pumpWidget(
        BlocProvider<AudioBloc>(
          ...
          child: const MaterialApp(home: DebugWidget()),
        ),
      );
